...
const OFF = 0, LOW = 1, MEDIUM = 2, HIGH = 3, INSANE = 4;
const PASS = 11, FAIL = 12, NEUTRAL = 13;

const AR = class Antiraid {
  /**
...
const removeDupls = (arr) => Array.from(new Set(arr));

exports.AR = AR;
exports.ARStore = ARStore;
